...
class PygameDisplay(wx.Window):
    def __init__(self, parent, ID):
        ...
        self.Bind(wx.EVT_BUTTON, self.draw_new_card, self.draw_button)
...
class Frame(wx.Frame):
    def __init__(self, parent):
        ...
        self.Bind(wx.EVT_MENU, self.on_new_game, m_new_game)
